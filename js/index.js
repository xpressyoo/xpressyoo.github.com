    ...
    MapDefault();
        function MapDefault() {
            ...
            $.getJSON('http://api.wipmania.com/jsonp?callback=?', function(data) {
                ...
                if (country === 'United Kingdom' || country === 'United States of America' || country === 'United States' || country === 'USA') { $('#country').empty().append('the ' + country); }
                else { $('#country').empty().append(country); }
                var perso = [{
                    stylers: [{
                        visibility: "on"
                    }, {
...
var BrowserDetect = {
    ...
    // Language
    var langtxt;
    if (lang === 'fr') { langtxt ='Bonjour';}
    else if(lang === 'it') { langtxt ='Ciao';}
    else if(lang === 'de') { langtxt ='Hallo';}
    else if(lang === 'es') { langtxt ='Hola';}
    else if(lang === 'pt') { langtxt ='Olá';}
    else if(lang === 'zh') { langtxt ='你好';}
    else if(lang === 'ja') { langtxt ='こんにちは';}
    else if(lang === 'ko') { langtxt ='안녕하세요';}
    else if(lang === 'he') { langtxt ='שלום';}
    else if(lang === 'ru') { langtxt ='привет';}
    else if(lang === 'hi') { langtxt ='नमस्ते';}
    else if(lang === 'ar') { langtxt ='مرحبا';}
    else { langtxt ='Hello'; }
