...
// Location
        ...
        if (country === 'United Kingdom') {img = 'en';credits = 'London at Night';}
        else if (country === 'Canada') {img = 'ca';credits = 'Aurora Borealis Over Canada';}
        else if (country === 'Switzerland' || country === 'France' || country === 'Italy' || country === 'Spain') {img = 'eu';credits = 'South of Europe at Night';}
        else if (country === 'United States of America' || country === 'USA' || country === 'United States') { img = 'us';credits = 'U.S. East Coast at Night'}
        else {img = 'ca';credits = 'Aurora Borealis Over Canada';}
...
if (referer === '') { referer = 'Direct link';}
...
$('html, body').animate({ scrollTop: $("#fname").offset().top }, 500);
}, 8000);
...
if (fname === 'Aurelia' && country === 'France'){fname = 'Chipie'}
else if (fname === 'Bérénice' && country === 'Switzerland'){fname = 'Petite Soeur'}
else if (fname === 'Marcel' && country === 'Switzerland'){fname = 'Papa'}
else if (fname === 'Béatrice' && country === 'Switzerland'){fname = 'Maman'}
...
$('#msg').fadeIn('slow').removeClass('hide').css({'background' : 'url("'+ img +'.jpg") no-repeat 0 0'});
